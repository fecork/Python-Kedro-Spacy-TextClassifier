...
# text_classifier_spacy documentation build
...
from text_classifier_spacy import __version__ as release

# -- Project information -----------------------------------------------------

project = "text_classifier_spacy"
author = "Kedro"
...
htmlhelp_basename = "text_classifier_spacydoc"
...
latex_documents = [
    (
        master_doc,
        "text_classifier_spacy.tex",
        "text_classifier_spacy Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "text_classifier_spacy",
        "Project text_classifier_spacy codebase.",
        "Data-Science",
    )
]
